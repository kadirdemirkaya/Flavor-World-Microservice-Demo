...
namespace BuildingBlock.Redis
{
        ...
        where T : RedisModel
    {
        ...
        public RedisRepository(InMemoryConfig memoryConfig, IServiceProvider serviceProvider)
        {
            ...
            persistentConnection = new RedisPersistentConnection(_redis, InMemoryConfig);
