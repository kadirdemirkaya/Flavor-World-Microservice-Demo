...
namespace BuildingBlock.Dapper
{
    public class DapperPersistenceConnection : IDisposable, IDbStrategy
    {
        ...
        public DapperPersistenceConnection(string connectionString, int retryCount = 5)
        {
        ...
        public DapperPersistenceConnection(DbContext dbContext, string connectionString, int retryCount = 5)
        {
        ...
        {
            _dbStrategy = new SqlServerStrategy(_connectionString);
        }
