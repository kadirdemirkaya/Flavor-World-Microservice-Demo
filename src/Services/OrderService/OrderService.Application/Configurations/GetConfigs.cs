...
namespace OrderService.Application.Configurations
{
    public static class GetConfigs
    {
        ...
        public static AgentServiceRegistration GetAgentServiceRegistration
        {
            get
            {
                return new()
                {
                    ID = OrderService.Domain.Constants.Constant.OrderConsul.ID,
                    Name = OrderService.Domain.Constants.Constant.OrderConsul.Name,
                    Address = OrderService.Domain.Constants.Constant.OrderConsul.Host,
                    Port = int.Parse(OrderService.Domain.Constants.Constant.OrderConsul.Port),
                    Tags = new[] { OrderService.Domain.Constants.Constant.OrderConsul.Name, OrderService.Domain.Constants.Constant.OrderConsul.Tag }
                };
            }
        }
